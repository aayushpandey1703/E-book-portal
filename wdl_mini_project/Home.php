...
<!--
        ...
        <div class="small-container" id="scroll">
            ...
            if(isset($_SESSION['id']))
            {
            $check="select*from member_book where mid='".$_SESSION['id']."'";
            ...
            <div class="row">
                ...
                $query3="SELECT distinct member_book.sr, books.bid,bname,image,class,author,rate,link,description,date from books 
inner join member_book on member_book.bid=books.bid
where mid='".$_SESSION['id']."' order by member_book.sr desc LIMIT 4";
                 ...
                 <div class="col-4">
                        ...
                        <div class="butn">
                            <form action="description.php" method="post">
                                 <input type="hidden" name="bid" value="<?php echo $product3['bid']; ?>">
                            <button type="submit" name="view">
                              View more<i class="fa fa-book" aria-hidden="true"></i>
                            </button>
                            <button><a href="pdf/<?php echo $product3['link']; ?>" download>
                        ...
                        <div class="butn">
                            ...
                            if(isset($_SESSION['id']))
                            {
                                ?>
                                 ...
                                 <form action="description.php" method="post">
                                 <input type="hidden" name="bid" value="<?php echo $product2['bid']; ?>">
                            <button type="submit" name="view">
                                View more <i class="fa fa-book" aria-hidden="true"></i>
                            </button>
            ...
            <div class="row">
                ...
                while ($product = mysqli_fetch_assoc($result)) {
                    ...
                    <div class="col-4">
                        ...
                        <div class="butn">
                           ...
                           <button> <a href="pdf/<?php echo $product['link']; ?>" download>
                                   Download</a> <i class="fa fa-cloud-download" aria-hidden="true"></i>
                                </button>
                                </form>
                            <?php
                ...
                <form action="book.php" method="post">
                    ...
                    <input type="hidden" name="class" value="Class 9" />
                    View All &#10141;</button>
                    </form>
                </div>
            </div>
            ...
            <div class="row">
                 <?php
                $query = "select * from books where class='Class 10' limit 4";
                $result = mysqli_query($con, $query);
                while ($product = mysqli_fetch_assoc($result)) {
                    $rate = (int) $product['rate'];
                    ?>
            ...
            <div class="row">
  <?php
                $query = "select * from books where class='Class 11' limit 4";
                $result = mysqli_query($con, $query);
                while ($product = mysqli_fetch_assoc($result)) {
                    $rate = (int) $product['rate'];
                    ?>
                ...
                ?>
                <div> <form action="book.php" method="post">
                    <button type="submit" class="btn">
                    <input type="hidden" name="class" value="Class 11" />
                    View All &#10141;</button>
                    </form>
                </div>
            </div>
            ...
            <div class="row">
             <?php
                $query = "select * from books where class='Class 12' limit 4";
                $result = mysqli_query($con, $query);
                while ($product = mysqli_fetch_assoc($result)) {
                    $rate = (int) $product['rate'];
                    ?>
                ...
                <div> <form action="book.php" method="post">
                    <button type="submit" class="btn">
                    <input type="hidden" name="class" value="Class 12" />
                    View All &#10141;</button>
                    </form>
                </div>
            </div>
